 ...
 * All rights reserved.
 *
 * Modified with minimum valid parameters for yespower compatibility
 */
...
/*
 * Minimum valid parameters for standard compatibility
 */
#define PWXsimple 2
#define PWXgather 4
/* Version 0.5 - MINIMUM VALID */
#define PWXrounds_0_5 6  // Must be 6 for YESPOWER_0_5 compatibility
#define Swidth_0_5 8
/* Version 1.0 - MINIMUM VALID */
#define PWXrounds_1_0 3  // Must be 3 for YESPOWER_1_0 compatibility
    ...
    const yespower_params_t *params, yespower_binary_t *dst)
{
	...
	if ((version != YESPOWER_0_5 && version != YESPOWER_1_0) ||
	    N < 16 || N > 512 * 1024 || r < 8 || r > 32 ||  // MINIMUM: N=16, r=8
	    (N & (N - 1)) != 0 || r < rmin ||
	    (!pers && perslen)) {
		errno = EINVAL;
		return -1;
	...
	/* STANDARD ROUNDS for compatibility */
	ctx.version = version;
	if (version == YESPOWER_0_5) {
		ctx.salsa20_rounds = 8;  // STANDARD: Must be 8 for YESPOWER_0_5
		ctx.PWXrounds = PWXrounds_0_5;  // STANDARD: 6
		ctx.Swidth = Swidth_0_5;
		ctx.Sbytes = 2 * Swidth_to_Sbytes1(ctx.Swidth);
	} else {
		ctx.salsa20_rounds = 2;  // STANDARD: Must be 2 for YESPOWER_1_0
		ctx.PWXrounds = PWXrounds_1_0;  // STANDARD: 3
