...
// -- Removed AVX/XOP warning lines here and below in yespower-opt.c --
...
void sha256d(unsigned char *hash, const unsigned char *data, int len)
{
    ...
    memcpy(S + 8, sha256d_hash1 + 8, 8 * sizeof(uint32_t));
    sha256_init(T);
